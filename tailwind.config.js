...
const themes = {
    ...
    acentusRose: {
        primary: {
            ...customColors.acentusRose,
            DEFAULT: customColors.acentusRose[600],
        }
    },
    acentusGreen: {
        primary: {
            ...customColors.acentusGreen,
            DEFAULT: customColors.acentusGreen[600],
        }
    },
    acentusPurple : {
        primary: {
            ...customColors.acentusPurple,
            DEFAULT: customColors.acentusPurple[600],
        }
    },
};
