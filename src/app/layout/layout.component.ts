...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    searchRoute;
    private queryParamsSubscribed = false;
    ...
    ngOnInit(): void {
        ...
        this._activatedRoute.queryParams.pipe(untilDestroyed(this)).subscribe(params => {
            if (!this.queryParamsSubscribed && params['search']) {
                this.openSearchModal();
            }
        });
        // Set the flag to true to prevent multiple subscriptions
        this.queryParamsSubscribed = true;
    }
