...
@UntilDestroy()
@Component({
    selector: 'ac-vendor-center',
    templateUrl: './vendor-center.component.html',
    styleUrls: ['./vendor-center.component.scss'],
...
export class VenderCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
