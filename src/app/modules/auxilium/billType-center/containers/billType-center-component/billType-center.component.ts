...
@UntilDestroy()
@Component({
    selector: 'ac-billType-center',
    templateUrl: './billType-center.component.html',
    styleUrls: ['./billType-center.component.scss'],
...
export class BillTypeCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
    ...
    menuData: FuseNavigationItem[] = [
        {
            title: 'Actions',
            subtitle: 'Add new BillType Key',
            type: 'group',
            children: [
                {
                    title: 'Add BillType Rep',
                    type: 'basic',
