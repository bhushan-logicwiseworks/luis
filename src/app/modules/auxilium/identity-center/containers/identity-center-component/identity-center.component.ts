...
import { IdentityCenterIndividualFormComponent } from '../../components/identity-center-individual-form/identity-center-individual-form.component';
...
@UntilDestroy()
@Component({
    selector: 'ac-identity-center',
    templateUrl: './identity-center.component.html',
    styleUrls: ['./identity-center.component.scss'],
...
export class IdentityCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
    ...
    openCreate() {
        const popupData: PopupData = {
            ...
            saveButtonText: 'Save',
            dynamicComponent: IdentityCenterIndividualFormComponent,
