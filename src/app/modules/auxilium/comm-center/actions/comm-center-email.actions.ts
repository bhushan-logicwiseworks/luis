...
const ResetState = createAction('[CommCenter Email/API] Reset email State');
...
const PatientSearch = createAction(
    '[CommCenter Patient Search/API] Link Patient Search',
    props<{ patientSearch: Patient }>()
);
const PatientSearchSuccess = createAction(
    '[CommCenter Patient Search/API] Link Patient Search Success',
    props<{ patient: Patient }>()
);
const PatientSearchFailure = createAction(
    '[CommCenter Patient Search/API] Link Patient Search Failure',
    props<{ error: Error }>()
);

const PatientFaxIntoPatientRecord = createAction(
    '[CommCenter Patient Search/API] Fax Link Patient Search',
    props<{ contactInfo: any }>()
);
const PatientFaxIntoPatientRecordSuccess = createAction(
    '[CommCenter Patient Search/API] Fax Link Patient Search Success',
    props<{ patient: Patient }>()
);
const PatientFaxIntoPatientRecordFailure = createAction(
    '[CommCenter Patient Search/API] Fax Link Patient Search Failure',
    props<{ error: Error }>()
);

const UpdateEmailGroupEdit = createAction(
    '[CommCenter Email/API] Update Email Group Edit',
    props<{ emailEditGroup: EmailGroupEdit }>()
);
const UpdateEmailGroupEditSuccess = createAction('[CommCenter Email/API] Update Email Group Edit Success');
const UpdateEmailGroupEditFailure = createAction(
    '[CommCenter Email/API] Update Email Group Edit Failure',
    props<{ error: Error }>()
);
...
export const CommCenterEmailActions = {
    ...
    UpdateEmailGroupEdit,
    UpdateEmailGroupEditSuccess,
    UpdateEmailGroupEditFailure,
    ResetState,
};
