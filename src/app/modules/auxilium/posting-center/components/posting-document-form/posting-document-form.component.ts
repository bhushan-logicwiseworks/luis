...
import { PatientDocumentsActions } from '../../../patient-center/actions/patient-documents.actions';

@UntilDestroy()
@Component({
    selector: 'posting-document-form',
    templateUrl: './posting-document-form.component.html',
    styleUrls: ['./posting-document-form.component.scss'],
...
export class PostingDocumentFormComponent implements OnInit {
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<PostingDocumentFormComponent>,
