...
@UntilDestroy()
@Component({
    selector: 'app-posting-center',
    templateUrl: './posting-center.component.html',
    styleUrl: './posting-center.component.scss',
    imports: [
        MatIcon,
        ReactiveFormsModule,
        MatIconButton,
...
export class PostingCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
