...
@UntilDestroy()
@Component({
    selector: 'ac-code-center',
    templateUrl: './code-center.component.html',
    styleUrls: ['./code-center.component.scss'],
...
export class CodeCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
