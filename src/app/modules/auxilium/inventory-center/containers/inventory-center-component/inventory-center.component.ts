...
import { InventoryCenterIndividualFormComponent } from '../../components/inventory-center-individual-form/inventory-center-individual-form.component';
...
@UntilDestroy()
@Component({
    selector: 'ac-inventory-center',
    templateUrl: './inventory-center.component.html',
    styleUrls: ['./inventory-center.component.scss'],
...
export class InventoryCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
    ...
    openCreate() {
        const popupData: PopupData = {
            ...
            saveButtonText: 'Save',
            dynamicComponent: InventoryCenterIndividualFormComponent,
            dynamicComponentData: null,
            submitFunction: 'saveInventory',
