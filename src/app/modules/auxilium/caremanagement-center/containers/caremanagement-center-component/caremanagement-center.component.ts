...
@UntilDestroy()
@Component({
    selector: 'app-caremanagement-center',
    templateUrl: './caremanagement-center.component.html',
    styleUrls: ['./caremanagement-center.component.scss'],
    imports: [
        MatIcon,
        ReactiveFormsModule,
        MatIconButton,
...
export class CareManagementCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
