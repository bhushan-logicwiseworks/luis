...
@UntilDestroy()
@Component({
    selector: 'ac-reorder-center',
    templateUrl: './reorder-center.component.html',
    styleUrls: ['./reorder-center.component.scss'],
...
export class ReorderCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
