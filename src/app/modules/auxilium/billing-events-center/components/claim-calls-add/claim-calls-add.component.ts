...
@UntilDestroy()
@Component({
    selector: 'app-claim-calls-add',
    templateUrl: './claim-calls-add.component.html',
    styleUrl: './claim-calls-add.component.scss',
...
export class ClaimCallsAddComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<ClaimCallsAddComponent>,
    ...
    saveClaimCalls(): void {
        ...
        billingevents = this.auxUtilService.transFormValuesToUpperCase(billingevents, ['contactNote', 'owner']);
        ...
        this.store.dispatch(
            BillingEventsCenterCreateActions.SaveBillingEvent({ data: billingevents, filter: 'claimcalls' })
        );
