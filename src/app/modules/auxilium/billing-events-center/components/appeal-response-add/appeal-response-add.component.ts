...
@UntilDestroy()
@Component({
    selector: 'app-appeal-response-add',
    templateUrl: './appeal-response-add.component.html',
    styleUrls: ['./appeal-response-add.component.scss'],
...
export class AppealResponseAddComponent {
    billingForm: UntypedFormGroup;
    billingevents: BillingEventsCenterDisplay | null;
    alert: { type: string; message: string } | null = null;
    patientId: number;
    primaryOrSecondaryOptions = ['PRIMARY', 'SECONDARY'];
    // isAppealForRefundOptions = [true, false];
    appealOutcomeOptions = ['Paid', 'Partial Paid', 'Denial'];
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<AppealResponseAddComponent>,
