...
@UntilDestroy()
@Component({
    selector: 'app-secondary-tertiary-appeals-denials-rejections-add',
    templateUrl: './secondary-tertiary-appeals-denials-rejections-add.component.html',
    styleUrl: './secondary-tertiary-appeals-denials-rejections-add.component.scss',
...
export class SecondaryTertiaryAppealsDenialsRejectionsAddComponent implements OnInit, AfterViewInit, OnDestroy {
    billingForm: UntypedFormGroup;
    billingevents: BillingEventsCenterDisplay | null;
    alert: { type: string; message: string } | null = null;
    patientId: number;

    adminErrorOptions: { value: string; description: string }[] = [
        { value: 'ADMIN1', description: 'Clerical Error' },
        { value: 'ADMIN2', description: 'Insurance Info Error' },
        { value: 'ADMIN3', description: 'Referring Physician Credentialing Issue' },
        { value: 'ADMIN4', description: 'Claim Requirements Per Insurance' },
        { value: 'ADMIN5', description: 'Requested Information to Process Claim' },
        { value: 'ADMIN6', description: 'Prior Authorization' },
        { value: 'ADMIN7', description: 'Network Issues' },
        { value: 'ADMIN8', description: 'Non-Covered' },
        { value: 'ADMIN9', description: 'Timely' },
        { value: 'ADMIN10', description: 'Service & Unit Issues' },
    ];

    secondaryOptions = [
        'SECONDARY APPEAL',
        'SECONDARY CORRECTED CLAIM',
        'SECONDARY DNL',
        'SECONDARY NEW CLAIM SUBMITTED',
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<SecondaryTertiaryAppealsDenialsRejectionsAddComponent>,
    ...
    ngOnInit(): void {
        this.billingForm = this.formBuilder.group({
            ...
            secondaryTertiaryInsId: ['', Validators.required],
            action: ['', Validators.required],
            isRefundResult: [false],
    ...
    saveSecondary(): void {
        ...
        this.store.dispatch(
            BillingEventsCenterCreateActions.SaveBillingEvent({ data: billingevents, filter: 'secondary' })
        );
    ...
    openPayorList() {
        ...
        dialogRef
            ...
            .subscribe(result => {
                if (result) {
                    this.billingForm.get('secondaryTertiaryInsId').setValue(result.id);
                }
            });
    }
}
