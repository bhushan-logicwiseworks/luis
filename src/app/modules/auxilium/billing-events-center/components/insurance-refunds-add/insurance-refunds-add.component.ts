...
@UntilDestroy()
@Component({
    selector: 'app-insurance-refunds-add',
    templateUrl: './insurance-refunds-add.component.html',
    styleUrl: './insurance-refunds-add.component.scss',
...
export class InsuranceRefundsAddComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    additionalInformationOptions: { value: string; description: string }[] = [
        { value: 'FR', description: 'Future Recoupment' },
        { value: 'FU', description: 'Follow up needed' },
        { value: 'Refund Invalid', description: 'No Action Need' },
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<InsuranceRefundsAddComponent>,
