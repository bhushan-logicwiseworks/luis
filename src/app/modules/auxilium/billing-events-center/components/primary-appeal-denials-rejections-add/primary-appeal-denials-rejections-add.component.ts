...
@UntilDestroy()
@Component({
    selector: 'app-primary-appeal-denials-rejections-add',
    templateUrl: './primary-appeal-denials-rejections-add.component.html',
    styleUrl: './primary-appeal-denials-rejections-add.component.scss',
...
export class PrimaryAppealDenialsRejectionsAddComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<PrimaryAppealDenialsRejectionsAddComponent>,
    ...
    ngOnInit(): void {
        this.billingForm = this.formBuilder.group({
            ...
            primaryInsId: ['', Validators.required],
    ...
    savePrimary(): void {
        ...
        this.store.dispatch(
            BillingEventsCenterCreateActions.SaveBillingEvent({ data: billingevents, filter: 'primary' })
        );
    ...
    openPayorList() {
        ...
        dialogRef
            ...
            .subscribe(result => {
                if (result) {
                    this.billingForm.get('primaryInsId').setValue(result.id);
                }
            });
    }
}
