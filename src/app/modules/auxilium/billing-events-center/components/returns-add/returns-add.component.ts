...
@UntilDestroy()
@Component({
    selector: 'app-returns-add',
    templateUrl: './returns-add.component.html',
    styleUrl: './returns-add.component.scss',
...
export class ReturnsAddComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    returnActionOptions = [
        'Items returned with no refund needed',
        'Items returned with refund completed',
        'Items returned with refund needed to patient',
        'Items returned with refund needed to primary insurance',
        'Items returned with refund needed to secondary insurance',
    ];
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<ReturnsAddComponent>,
    ...
    ngOnInit(): void {
        this.billingForm = this.formBuilder.group({
            ...
            dateFullyResolved: ['', Validators.required],
    ...
    saveReturns(): void {
        ...
        this.store.dispatch(
            BillingEventsCenterCreateActions.SaveBillingEvent({ data: billingevents, filter: 'returns' })
        );
