...
@UntilDestroy()
@Component({
    selector: 'ac-company-center',
    templateUrl: './company-center.component.html',
    styleUrls: ['./company-center.component.scss'],
...
export class CompanyCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
    ...
    openCreate() {
        // this.router.navigateByUrl(`/centers/company-center/demographics`);
    }
}
