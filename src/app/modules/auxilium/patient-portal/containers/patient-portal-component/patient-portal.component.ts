...
import { PatientPortalIndividualFormComponent } from '../../components/patient-portal-individual-form/patient-portal-individual-form.component';

@UntilDestroy()
@Component({
    selector: 'ac-patient-portal',
...
export class PatientPortalComponent implements OnInit, OnDestroy {
    ...
    openCreate() {
        const popupData: PopupData = {
            ...
            saveButtonText: 'Save',
            dynamicComponent: PatientPortalIndividualFormComponent,
