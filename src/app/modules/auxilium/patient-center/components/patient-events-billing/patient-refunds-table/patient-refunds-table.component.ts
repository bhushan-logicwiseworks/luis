...
import { PatientRefundsAddComponent } from '../../../../billing-events-center/components/patient-refunds-add/patient-refunds-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-patient-refunds-table',
    templateUrl: './patient-refunds-table.component.html',
    styleUrls: ['./patient-refunds-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientRefundsTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
