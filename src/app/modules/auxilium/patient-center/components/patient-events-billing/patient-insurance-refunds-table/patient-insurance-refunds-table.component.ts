...
import { InsuranceRefundsAddComponent } from '../../../../billing-events-center/components/insurance-refunds-add/insurance-refunds-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-patient-insurance-refunds-table',
    templateUrl: './patient-insurance-refunds-table.component.html',
    styleUrls: ['./patient-insurance-refunds-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientInsuranceRefundsTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
