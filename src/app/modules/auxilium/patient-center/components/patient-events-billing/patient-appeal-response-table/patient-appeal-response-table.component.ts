...
import { AppealResponseAddComponent } from '../../../../billing-events-center/components/appeal-response-add/appeal-response-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-patient-appeal-response-table',
    templateUrl: './patient-appeal-response-table.component.html',
    styleUrls: ['./patient-appeal-response-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientAppealResponseTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
