...
import { OpenARReportAddComponent } from '../../../../billing-events-center/components/open-ar-report-add/open-ar-report-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-open-ar-report-table',
    templateUrl: './patient-open-ar-report-table.component.html',
    styleUrls: ['./patient-open-ar-report-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientOpenArReportTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
