...
import { ClaimCallsAddComponent } from '../../../../billing-events-center/components/claim-calls-add/claim-calls-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-claim-calls-table',
    templateUrl: './patient-claim-calls-table.component.html',
    styleUrls: ['./patient-claim-calls-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientClaimCallsTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
    ...
    visibleColumns: string[] = ['todaysDate', 'claimDateOfService', 'owner', 'insuranceId', 'comments'];
    paginationOptions = {
        pageSize: 20,
