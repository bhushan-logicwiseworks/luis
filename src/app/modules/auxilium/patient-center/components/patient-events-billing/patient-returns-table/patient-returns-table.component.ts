...
import { ReturnsAddComponent } from '../../../../billing-events-center/components/returns-add/returns-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-patient-returns-table',
    templateUrl: './patient-returns-table.component.html',
    styleUrls: ['./patient-returns-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientReturnsTableComponent implements OnInit, OnDestroy {
    patientId: number;
    title: string;
    ...
    columnDefs: ColDef[] = [
        ...
        },
        {
            ...
            valueFormatter: params => this.datePipe.transform(params.data.dateFullyResolved),
            filter: 'agDateColumnFilter',
            filterParams: filterParams,
            minWidth: 180,
        },
