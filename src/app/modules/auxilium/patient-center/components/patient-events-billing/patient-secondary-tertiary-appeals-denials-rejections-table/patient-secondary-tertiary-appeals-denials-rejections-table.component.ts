...
import { SecondaryTertiaryAppealsDenialsRejectionsAddComponent } from '../../../../billing-events-center/components/secondary-tertiary-appeals-denials-rejections-add/secondary-tertiary-appeals-denials-rejections-add.component';
...
@UntilDestroy()
@Component({
    selector: 'app-patient-secondary-tertiary-appeals-denials-rejections-table',
    templateUrl: './patient-secondary-tertiary-appeals-denials-rejections-table.component.html',
    styleUrls: ['./patient-secondary-tertiary-appeals-denials-rejections-table.component.scss'],
    providers: [DateFormatPipe],
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [AuxAgGridComponent, AsyncPipe, FuseHorizontalNavigationComponent],
})
export class PatientSecondaryTertiaryAppealsDenialsRejectionsTableComponent implements OnInit {
    patientId: number;
    title: string;
