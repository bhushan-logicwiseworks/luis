...
@UntilDestroy()
@Component({
    selector: 'app-patient-audit-notes',
    templateUrl: './patient-audit-notes.component.html',
    styleUrls: ['./patient-audit-notes.component.scss'],
    imports: [
        ScrollbarComponent,
        NgClass,
...
export class PatientAuditNotesComponent implements OnInit {
    ...
    constructor(
        ...
        private store: Store,
        private dialogRef: MatDialogRef<PatientAuditNotesComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any
    ) {
        this.contactNotes$ = this.store.select(PatientAuditSelectors.selectContactNotes);
    ...
    private initForm(): void {
        ...
        const moduleName = dynamicData.moduleName || 'AUDIT';
        const contactType = 'AUDIT';
    ...
    saveContactNote(): void {
        ...
        this.store.dispatch(AuditActions.AddContactNote({ note }));
