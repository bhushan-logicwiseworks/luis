...
@UntilDestroy()
@Component({
    selector: 'app-patient-subsequent-payments-edit',
    templateUrl: './patient-subsequent-payments-edit.component.html',
    styleUrls: ['./patient-subsequent-payments-edit.component.scss'],
    imports: [
        MatIcon,
        MatPrefix,
        FuseHorizontalNavigationComponent,
...
export class PatientSubsequentPaymentsEditComponent {
