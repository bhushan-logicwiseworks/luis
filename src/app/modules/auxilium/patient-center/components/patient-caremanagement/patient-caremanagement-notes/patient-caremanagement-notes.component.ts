...
@Component({
    selector: 'app-patient-caremanagement-notes',
    templateUrl: './patient-caremanagement-notes.component.html',
    styleUrl: './patient-caremanagement-notes.component.scss',
    imports: [
        ScrollbarComponent,
        NgClass,
...
export class PatientCaremanagementNotesComponent {
    ...
    constructor(
        ...
        private store: Store,
        private dialogRef: MatDialogRef<PatientCaremanagementNotesComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any
    ) {
        this.contactNotes$ = this.store.select(PatientCareManagementSelectors.selectContactNotes);
    ...
    private initForm(): void {
        ...
        const moduleName = dynamicData.moduleName || 'CAREMANAGEMENT';
        const contactType = 'CAREMANAGEMENT';
    ...
    saveContactNote(): void {
        ...
        this.store.dispatch(PatientCareManagementActions.AddContactNote({ note }));
