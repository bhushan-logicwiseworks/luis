...
@UntilDestroy()
@Component({
    selector: 'app-patient-group-edit-work-order',
    templateUrl: './patient-group-edit-work-order.component.html',
    styleUrls: ['./patient-group-edit-work-order.component.scss'],
...
export class PatientGroupEditWorkOrderComponent {
    isLinear = false;
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<PatientGroupEditWorkOrderComponent>
    ) {
    ...
    submit() {
        ...
        this.store.dispatch(PatientWorkOrderActions.EditGroupWorkEdit({ patientData }));
