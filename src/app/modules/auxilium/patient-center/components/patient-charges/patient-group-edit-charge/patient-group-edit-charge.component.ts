...
@UntilDestroy()
@Component({
    selector: 'app-patient-group-edit-charge',
    templateUrl: './patient-group-edit-charge.component.html',
    styleUrls: ['./patient-group-edit-charge.component.scss'],
...
export class PatientGroupEditChargeComponent {
    isLinear = false;
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<PatientGroupEditChargeComponent>
    ) {
    ...
    submit() {
        let chargesData = this.patientGroupEditForm.value;
        chargesData['numbers'] = this.patientGroupData;
        this.store.dispatch(PatientChargesActions.EditGroupCharges({ chargesData }));
