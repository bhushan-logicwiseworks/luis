...
@UntilDestroy()
@Component({
    selector: 'app-intake-center',
    templateUrl: './intake-center.component.html',
    styleUrl: './intake-center.component.scss',
    imports: [
        MatIcon,
        ReactiveFormsModule,
        MatIconButton,
...
export class IntakeCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    icon: 'heroicons_outline:tag',
                    classes: {
                        icon: labelColorDefs['yellow'].text,
                        wrapper: 'padding-style',
                    },
                    link: './pending',
                },
