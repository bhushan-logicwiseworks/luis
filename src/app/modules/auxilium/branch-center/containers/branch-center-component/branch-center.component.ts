...
@UntilDestroy()
@Component({
    selector: 'ac-branch-center',
    templateUrl: './branch-center.component.html',
    styleUrls: ['./branch-center.component.scss'],
...
export class BranchCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
