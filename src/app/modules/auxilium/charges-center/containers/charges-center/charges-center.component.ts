...
@UntilDestroy()
@Component({
    selector: 'app-charges-center',
    templateUrl: './charges-center.component.html',
    styleUrls: ['./charges-center.component.scss'],
    imports: [
        MatIcon,
        ReactiveFormsModule,
        MatIconButton,
...
export class ChargesCenterComponent {
    toggleMenu = false;
