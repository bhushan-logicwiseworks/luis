...
@UntilDestroy()
@Component({
    selector: 'ac-hotkeys-center',
    templateUrl: './hotkeys-center.component.html',
    styleUrls: ['./hotKeys-center.component.scss'],
...
export class HotKeysCenterComponent implements OnInit, OnDestroy {
    toggleMenu = false;
    ...
    menuData: FuseNavigationItem[] = [
        {
            title: 'Actions',
            subtitle: 'Add new Hot Key',
            type: 'group',
            children: [
                {
                    title: 'Add HotKeys Rep',
                    type: 'basic',
